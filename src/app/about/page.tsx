...
const page = () => {
  return (
    <main className="p-10">
      <div>
        <Link href={"/"} className="cursor-pointer roboto text-7xl font-bold">
          About BitArena
        </Link>
        ...
        <div className="border-l-6 pl-2 mt-4 border-l-blue-400">
          <h1 className="font-light text-xl">
            ...
            <span className="font-bold">community of thoughtfulplayers</span>
          </h1>
        </div>
        <div className="mt-10">
          <h1 className="text-2xl font-semibold">The Story</h1>
          <div className="flex items-center">
            ...
            <div className="ml-6 mt-2">
              <h1 className="text-blue-400/70 text-md md:text-lg">
      ...
      <div className="mt-10">
        <h1 className="text-2xl font-semibold">Meet the developer</h1>
        <div className="flex items-center mt-3  ">
          <a
            href="https://www.linkedin.com/in/muhammadkhubabsiddiqui"
            className="cursor-pointer h-20 w-25 md:h-30 md:w-30 overflow-hidden rounded-full border-3 border-blue-400"
          >
            <img
